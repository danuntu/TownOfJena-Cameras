...
map.getView().fit([-10256034.015632, 3721343.037242, -10254240.653712, 3722621.623810], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Jena Park and Walking Trails - Cameras and Networking</h2>';
        return titleElement;
    })(),
